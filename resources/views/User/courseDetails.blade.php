    ...
    <div class="col-md-3" style="background: #f8f9fb;">
        <div class="row" style="text-align: center">
            <div class="col-md-12" style="padding: 50px 10px">
                ...
                <img src="{{asset('img/icons/facebook.svg')}}" style=" width: 30px" class="fab fa-facebook">
                <img src="{{asset('img/icons/twitter.svg')}}" style="width: 30px" class="fab fa-twitter" >
                <img src="{{asset('img/icons/whatsapp.svg')}}" style="width: 30px" class="fab fa-whatsapp">
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
